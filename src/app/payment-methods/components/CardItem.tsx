  ...
  return (
    ...
    >
      <div className="flip-card-inner">
        {/* Front */}
        <div
          className={`flip-card-front bg-gradient-to-r ${theme.front} text-white p-6 rounded-2xl shadow-md min-h-[12rem] flex flex-col justify-between backface-hidden`}
        >
        ...
        {/* Back */}
        <div
          className={`flip-card-back absolute inset-0 bg-gradient-to-r ${theme.back} text-white p-6 rounded-2xl shadow-md min-h-[12rem] flex flex-col justify-between backface-hidden transform rotate-y-180`}
        >
